...
def main(args):
    ...
    hparams.output_dir = "/data/bharat/XAI/experiments"
    ...
    if 'strategy' in [param.name for param in params]:
        ...
        trainer = pl.Trainer(resume_from_checkpoint=resume_from_checkpoint,
                             ...
                             num_sanity_val_steps=5 if hparams.batch_size > 63 else 100,
        ...
        trainer = pl.Trainer(resume_from_checkpoint=resume_from_checkpoint,
                             ...
                             val_check_interval=1.0 if hparams.epochs > 4 else 0.1,
                             accumulate_grad_batches=hparams.accumulate_grad_batches,
                             limit_train_batches=0.1 if hparams.test_run else 1.0
                             )
