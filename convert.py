...
def load_bin(path, rootdir, image_size=[224,224]):

    test_transform = trans.Compose([
                trans.Resize((224,224), interpolation=BICUBIC),
                trans.ToTensor(),
                #trans.Normalize([0.5, 0.5, 0.5], [0.5, 0.5, 0.5])
                trans.Normalize((0.48145466, 0.4578275, 0.40821073), (0.26862954, 0.26130258, 0.27577711))
            ])
